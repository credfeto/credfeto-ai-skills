---
name: credfeto-readme-documentation
description: Write and maintain README.md with the required section order, reference-style badge links, and the all-contributors section. Use whenever creating or updating README.md, adding a config option that needs documenting, or adding/removing a badge.
---
...
2. **Badges** — see Badge Guidelines below.
...
12. **Contributors** — all-contributors section; see Contributors below for when to include it.
