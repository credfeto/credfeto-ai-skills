---
name: credfeto-error-handling
description: Handle and propagate errors explicitly — catch only what can be meaningfully handled, preserve root causes when wrapping, and sanitise errors surfaced to external callers. Use whenever writing or reviewing error handling, exception handling, or error propagation code in any language.
---
