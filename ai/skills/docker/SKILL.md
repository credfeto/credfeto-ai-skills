...
- Pin base image versions explicitly (e.g. `alpine:3.20` or a digest) — never `latest`, unless explicitly required by local instructions. Check the image registry for the current stable release before pinning.
