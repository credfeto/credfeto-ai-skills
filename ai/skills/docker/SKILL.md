---
name: credfeto-docker
description: Author and run Dockerfiles and Compose files safely: runner detection (Docker vs Podman), multi-stage builds, version pinning, non-root users, and image security basics. Use whenever a Dockerfile, Containerfile, docker-compose*.yml/yaml, compose.yml/yaml, or .dockerignore is present, or container work is needed.
---
