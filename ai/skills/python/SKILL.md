---
name: credfeto-python
description: Configure Python projects with isolated virtual environments, target only Python 3 (latest stable release), and write idiomatic, modular, testable Python. Use whenever a pyproject.toml, requirements.txt, setup.py, setup.cfg, or .py file is present, or Python work is being done.
---
